...
<script>
	...
	jQuery(function($) {
        ...
        jQuery("#grid-table-detail").jqGrid({
            ...
            colModel: [
                {label: 'Jenis Dokumen', name: 'P_KODE_DIVRE', hidden: false},                
                {label: 'Deskripsi', name: 'P_BISNIS_AREA', hidden: false},                
                {label: 'Origin Filename', name: 'P_NOTEL', hidden: false},
                {label: 'File Folder', name: 'P_KODE_PRODUK', hidden: false},
                {label: 'File Name', name: 'P_CUST_ID', hidden: false}
			],
            height: '100%',
            autowidth: true,
            viewrecords: true,
