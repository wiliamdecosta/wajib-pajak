...
<script>
	jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."transaksi.transaksi_harian_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
			postData: {
            ...
            colModel: [
                ...
                {label: 'Status', name: 'P_ORDER_STATUS_ID', hidden: false, editable: true},
                {label: 'Jumlah Transaksi', name: 'JUM_TRANS', hidden: false, editable: true},
                {label: 'Jumlah Pajak', name: 'FASTEL', hidden: false, editable: true}                
			],
            height: '100%',
            autowidth: true,
            viewrecords: true,
